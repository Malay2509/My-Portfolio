...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://formspree.io/f/mgavkvoe', {
        method: 'POST',
        headers: {
  ...
  const contactItems = [
    ...
    },
    {
      ...
      label: 'LinkedIn',
      value:
        'https://www.linkedin.com/in/malay-singh-bisht-1b53a91b5/',
      href: personal.social.linkedin,
    },
    {
      icon: <GithubIcon size={18} />,
      label: 'GitHub',
      value: 'https://github.com/Malay2509',
      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <p className="section-subtitle">
            I'm actively looking for full-stack and backend opportunities.
            Let's discuss roles!
          </p>
        </div>
